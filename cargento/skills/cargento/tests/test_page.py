...
class FrontendAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_all_three_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "project.js": (
                71_069,
                "b113963ffce95b07890f7aec5a01cefac1ea697c873aed873b760ddf17d82cd4",
            ),
            "calm.js": (
                57_092,
            ...
            "main.js": (
                13_016,
                "b9376bea9cc07136c6acb8844287ff437867f3481305f58c2cd6e51881ace5bd",
            ),
            "live.js": (
                6_176,
        ...
        self.assertEqual(80_524, len(styles))
        self.assertEqual(
            "584489d20dc49622846b3fbe2cd8588a06a0905d97828d20391e3e70c0fce7b6",
            hashlib.sha256(styles).hexdigest(),
        )

        assembled = frontend_page.load_page()
        self.assertEqual(414_791, len(assembled))
        self.assertEqual(
            "2b10827e4a04a2f20a0737abf9b4c0da0525b6b2aa69637deec794985d8aa55a",

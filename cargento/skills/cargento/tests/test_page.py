...
class FrontendAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_all_three_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "project.js": (
                39_663,
                "347dfdd0abf4f0206209ccf7d768502e8d0e7e813963be025a1ed9af55c4ce53",
            ),
            "calm.js": (
                57_092,
        ...
        self.assertEqual(382_508, len(assembled))
        self.assertEqual(
            "48749ef8d4caeba5f5cad3d1d598c9e54b194ca496d7431e595010457dff43dd",

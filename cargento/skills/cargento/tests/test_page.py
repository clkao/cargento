...
class FrontendAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_all_three_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "session.js": (
                27_767,
                "af5a1436c8ade8be5c77084d3216c7ffcb38517e1c6f8bc515fbcbbef1efc3d2",
            ),
            "notify.js": (
                3_185,
            ...
            "main.js": (
                10_051,
                "53cd35b019e6e297f05d95691ea9e6e07105ee9ec3183aff6a1f557d060199f6",
            ),
            "live.js": (
                6_176,
        ...
        self.assertEqual(59_555, len(styles))
        self.assertEqual(
            "a747769d110c0028052f8b6ecfda69b66d5e53ef2d72121205fa74b09cb41271",
            hashlib.sha256(styles).hexdigest(),
        )

        assembled = frontend_page.load_page()
        self.assertEqual(281_189, len(assembled))
        self.assertEqual(
            "0f250fecffc7e3e661f79fdafccd9b55940bf103da7d9fd8a86618b29dcb7f51",

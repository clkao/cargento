...
class FrontendAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_all_three_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "project.js": (
                34_049,
                "78dbe7201392ffaa57d240d5ea2359dfa5891d527b29eb7f9afe062d25974ae4",
            ),
            "calm.js": (
                57_092,
        ...
        self.assertEqual(373_256, len(assembled))
        self.assertEqual(
            "3a0d165580c1ca1ab5412e63437d4ffe6e0d6df7b4384d5586fad35d14c37346",

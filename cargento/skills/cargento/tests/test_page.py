...
class FrontendAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_all_three_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "project.js": (
                60_023,
                "b4ebe04f5db83eb6ff2082e5012dabdb5ae1ba81229a60a505bdf689c2dea747",
            ),
            "calm.js": (
                57_092,
            ...
            "main.js": (
                12_829,
                "7959e49531ef31cb02a10c086cd2c004c0102a5a11b73db1cb2cd02e442c8e6d",
            ),
            "live.js": (
                6_176,
        ...
        self.assertEqual(79_868, len(styles))
        self.assertEqual(
            "97fa7d519057c9771b51b59b31498925cd9fb49bb8837e6cc308bdbb1e1868e3",
            hashlib.sha256(styles).hexdigest(),
        )

        assembled = frontend_page.load_page()
        self.assertEqual(402_902, len(assembled))
        self.assertEqual(
            "e391fb4c45d50ea914bb50aefac86a7b6c9ac368e4165d8c266d86f8bfd2c3c6",

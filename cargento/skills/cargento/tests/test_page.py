...
class FrontendAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_all_three_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "calm.js": (
                57_383,
                "45577b45b344f4a5f4e19bc34f45c069a81396f2f4a99d2778c61004769f7f3c",
            ),
            "session.js": (
                6_988,
        ...
        self.assertEqual(445_911, len(assembled))
        self.assertEqual(
            "a7a816c8846545316e31a8638a7496315a6c8b1ae592ec490bb6033cab10e8c8",

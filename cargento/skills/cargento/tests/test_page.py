...
class FrontendAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_all_three_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "project.js": (
                97_300,
                "9d2686a02c525e05db2dcdfa69d08eab4e826c37b27cf228a2674428c6bb785a",
            ),
            "calm.js": (
                57_092,
        ...
        self.assertEqual(443_870, len(assembled))
        self.assertEqual(
            "80a57347ff1e4d747880634deababb1b55a77ffb60e85fa2540520981cdf3782",

...
class FrontendAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_all_three_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "project.js": (
                51_195,
                "811542460d884f5bf1eab2a715de35a9b428f7ee2df37e9bf1c1987f59699993",
            ),
            "calm.js": (
                57_092,
        ...
        self.assertEqual(393_031, len(assembled))
        self.assertEqual(
            "ac08fb770f0dee41435e02178fdb7712708bf1583a77c2718b46aa1cbe4e35e0",

...
class FrontendAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_all_three_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "project.js": (
                98_716,
                "247e7d82f42c4733a559d0e069247a761e404b4a1c2287315ea910e65f3cec8f",
            ),
            "calm.js": (
                57_092,
        ...
        self.assertEqual(83_443, len(styles))
        self.assertEqual(
            "d400454ac1efd8a023f1c50892dd33f51040569aec2b713d7d111d47f079e30a",
            hashlib.sha256(styles).hexdigest(),
        )

        assembled = frontend_page.load_page()
        self.assertEqual(445_286, len(assembled))
        self.assertEqual(
            "c5d4b90618a4cef8fcaa893bc383eb63eb5c7a97b0940a49e0d1387f442d514b",

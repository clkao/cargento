...
class FrontendAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_all_three_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "project.js": (
                38_646,
                "be62e7674ff0cfc3274561b1b78fcd834fcb0a53f298c4d9790514663acc50d8",
            ),
            "calm.js": (
                57_092,
        ...
        self.assertEqual(378_953, len(assembled))
        self.assertEqual(
            "5c12e42a0e1b113f7347c543b15c67436db2346359a7e49c695c5ccb5bf47d04",

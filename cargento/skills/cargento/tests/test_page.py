...
class FrontendAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_all_three_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "project.js": (
                62_036,
                "64c44afd5a2f11c935e91afa3c02422af471e70cb879fea4da9000a597678a28",
            ),
            "calm.js": (
                57_092,
        ...
        self.assertEqual(404_915, len(assembled))
        self.assertEqual(
            "89d757e8506684889d55bd7c4f0d4bb92b52a168b65db67793b9d9280ed1bd0e",

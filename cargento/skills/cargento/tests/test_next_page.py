...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_next_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-cockpit.js": (
                46_114,
                "4cebbca1e8a878634fc5ebf96656aef4208c324d69c45415ad6f42da87bc855a",
            ),
            "next-render.js": (
                802,
        ...
        self.assertEqual(393_158, len(assembled))
        self.assertEqual(
            "086c2472101243dc5e12538b91b78a9ecb712144da4b1950e1bfded48eed195d",

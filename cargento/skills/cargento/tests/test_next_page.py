...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_next_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            "next-boot.js": (
                5_893,
                "ac72fc474e3995a82143a3b6bf6e0b5546bb54b8465c2b64aa0928574e44c37f",
            ),
            "next-cockpit-compat.js": (
                599,
            ...
            "next-chrome.js": (
                7_561,
                "9d86a0d55633189553b899d9d39108b7bf3e327841335e210fdb41a6e510ade1",
            ),
            "next-sessions.js": (
                3_961,
            ...
            "next-project.js": (
                11_067,
                "2efd5e92d4a98960f5e5f3a61ec364fefbe4d4561f0168b792e053f5e181de20",
            ),
            "next-activity.js": (
                4_513,
                "ae9f1b11f153d1cf6023695bd3baeb59cf466056f7fb69f25680990ae27ce85d",
            ),
            "next-session.js": (
                11_338,
            ...
            "next-cockpit.js": (
                71_873,
                "bc12ea0b6751ed3e63714b7f0664f2c153f5007715bdce8b905a1518363f247d",
            ),
            "next-render.js": (
                802,
        ...
        self.assertEqual(44_966, len(styles))
        self.assertEqual(
            "5834d48e8bf48986bbc440393548d9855591e8016f746d5d3337c786826bc5a6",
            hashlib.sha256(styles).hexdigest(),
        )

        assembled = frontend_page.load_next_page()
        self.assertEqual(422_166, len(assembled))
        self.assertEqual(
            "400ee5af6d31ebf3b573e6266618b07967c3d22e13ca7b9f8438047cd0c0637a",

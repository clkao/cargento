...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_next_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-cockpit.js": (
                13_215,
                "77cbca1190f63ae93efeebd5915dffde87a7a619c67d90cb5a1ddd24ff605397",
            ),
            "next-render.js": (
                802,
        ...
        self.assertEqual(347_543, len(assembled))
        self.assertEqual(
            "3b35a05b5f9fbbc38066e420d40f9b01e9ab76aa60b806c9c678d19f33094337",

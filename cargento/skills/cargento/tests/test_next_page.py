...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_next_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-cockpit.js": (
                63_634,
                "9e7b123c4fdbb29dd3367f4976de10b76d880817044b8c8d05de7c34aeb30aa0",
            ),
            "next-render.js": (
                802,
        ...
        self.assertEqual(412_476, len(assembled))
        self.assertEqual(
            "b2a569f55f1245b659c48d1bd53b52e0626a964b95f54a04194827deb2dd1342",

...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_next_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-cockpit.js": (
                63_396,
                "a81d2d67e987dddd74cdb7973523086d3bca9933f59e67a86c98815143a87177",
            ),
            "next-render.js": (
                802,
        ...
        self.assertEqual(413_130, len(assembled))
        self.assertEqual(
            "df91fbfb18c7fecad56520696081f038580e38a5a7f2dd1de1f20ebee185b73f",

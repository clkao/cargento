...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_next_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-chrome.js": (
                7_093,
                "fe1836088b80b0b5b90e8b9b3a437f3a985e06b0c4b07acb270aa01c932d5938",
            ),
            "next-sessions.js": (
                3_961,
            ...
            "next-cockpit.js": (
                53_173,
                "b8b5fb11b5359aa4bf9ce4887ad26ae58e3b091209f84b7a255b5b8ae97f0547",
            ),
            "next-render.js": (
                802,
        ...
        self.assertEqual(42_510, len(styles))
        self.assertEqual(
            "0ec6b228ab81ba3728dc922ed7816d55717270fa3899271b8a7512ae889d40b6",
            hashlib.sha256(styles).hexdigest(),
        )

        assembled = frontend_page.load_next_page()
        self.assertEqual(400_726, len(assembled))
        self.assertEqual(
            "a70a5bdc523ea6bdd38fe1810427bf9d956ba1a5dd3cacc1c11dff9958683df8",
